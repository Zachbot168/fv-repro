...
\bottomrule
\end{tabular}
\caption{T1: GPT-J-6B reproduction. Paper values are Todd et al. Table 6 (zero-shot accuracy with the task FV at their chosen layer, mean±std over seeds); ours are best-over-layer-sweep (single seed 42), so ours upper-bound the paper protocol.}
