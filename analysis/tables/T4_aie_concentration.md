**T4: Concentration of causal task signal. Share of total positive mean AIE mass captured by the top-10 (and top-1% of) heads, and the largest single-head mean AIE, averaged over the six tasks.**
